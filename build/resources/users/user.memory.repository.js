 ...
 * {@link module:user/repository}
 */
var create = function (user) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, DB.createUser(user)];
}); }); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, DB.updateUser(userFromDB, body)];
            case 2:
                _a.sent();
                return [4 /*yield*/, DB.getUserByID(id)];
            case 3:
                updatedUser = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, DB.removeUser(user)];
            case 2:
                _a.sent();
                return [2 /*return*/, user];
        }
