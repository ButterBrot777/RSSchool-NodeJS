...
var getAll = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, user_model_1.User.find()];
}); }); };
...
var getByID = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_model_1.User.findOne(id)];
            case 1:
                user = _a.sent();
                if (!user) {
...
var create = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newUser = new user_model_1.User(user);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                // return updatedUser;
                return [4 /*yield*/, user_model_1.User.update(id, body)];
            case 2:
                // await DB.updateUser(userFromDB, body);
                // const updatedUser = await DB.getUserByID(id);
                // return updatedUser;
                _a.sent();
                return [2 /*return*/, user_model_1.User.findOne(id)];
        }
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                // return user;
                _a.sent();
                return [4 /*yield*/, task_model_1.Task.find({ userId: id })];
            case 3:
                updateTasks = _a.sent();
