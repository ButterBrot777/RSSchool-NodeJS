...
var getAll = function (boardId) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, DB.getAllTasks(boardId)];
}); }); };
...
var getByID = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, DB.getTaskByID(id)];
            case 1:
                task = _a.sent();
                if (!task) {
 ...
 * {@link module:task/repository}
 */
var create = function (boardId, body) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, DB.createTask(boardId, body)];
}); }); };
...
var update = function (id, body) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, DB.updateTask(id, body)];
            case 1:
                dbTask = _a.sent();
                if (!dbTask) {
                    throw new createError.NotFound();
                }
                return [2 /*return*/, dbTask];
        }
    });
}); };
...
var remove = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, DB.removeTask(id)];
            case 1:
                dbTask = _a.sent();
                if (!dbTask) {
                    throw new createError.NotFound();
